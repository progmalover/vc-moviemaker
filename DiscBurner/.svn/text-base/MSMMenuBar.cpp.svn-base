...
BOOL CMSMMenuBar::LoadState(LPCTSTR lpszProfileName, int nIndex, UINT uiID)
{
	GetCmdMgr()->EnableMenuItemImage(ID_VIEW_DETAILS, FALSE);
	GetCmdMgr()->EnableMenuItemImage(ID_VIEW_THUMBNAIL, FALSE);
